...
type TopicRailProps = { mode: AppMode; workspaces?: WorkspaceResponse[]; currentId?: string | null; onSelect?: (workspace: WorkspaceResponse) => void; onCreate?: () => void; onRenamed?: (workspace: WorkspaceResponse) => void };

export function TopicRail({ mode, workspaces = [], currentId, onSelect, onCreate, onRenamed }: TopicRailProps) {
